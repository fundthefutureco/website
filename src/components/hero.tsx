    ...
    <div className="relative bg-primary">
      <div className="container relative mx-auto flex min-h-[60vh] items-center px-4 py-20 lg:min-h-[80vh]">
        ...
        <div className="relative w-full max-w-2xl pt-20 text-center mx-auto">
          ...
          <p className="mb-8 text-base sm:text-lg lg:text-xl text-white">
          ...
          <p className="mb-12 text-base sm:text-lg lg:text-xl text-white">
            Come and create a better future with us.
          </p>
          <div className="flex flex-col gap-4 sm:flex-row justify-center">
            <Link href="/contact">
              <Button size="lg" className="w-full sm:w-auto rounded-full bg-white text-primary hover:bg-white/90">
                Apply for a Grant
              </Button>
            </Link>
            <Link href="/contact">
              <Button size="lg" variant="outline" className="w-full sm:w-auto text-primary-foreground border-white hover:bg-white/10">
                Donate now
              </Button>
            </Link>
          </div>
